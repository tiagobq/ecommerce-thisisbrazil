  ...
  return (
    <main>
      <h2>Trocas e devoluções</h2>
                ...
                <p>Nossa equipe instruirá o cliente em como proceder com a troca ou devolução do produto.</p>

                <p>Assim que recebermos o pacote, faremos uma análise para confirmar que está tudo de acordo com as condições de devolução do Item. </p>

                <p>Depois da confirmação, nossa Equipe de Atendimento entrará em contato e neste caso você poderá escolher entre:</p>

                <p>1. Trocar por qualquer outro produto que esteja disponível em nosso estoque.</p>
